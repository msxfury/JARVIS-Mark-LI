...
try:
    from core.desktop_install import ensure_desktop_install
    ensure_desktop_install()
except SystemExit:
    raise
except Exception as e:
    print(f"[Setup] Desktop install skipped: {e}")

try:
    from core.bootstrap import ensure_runtime_requirements
    ensure_runtime_requirements(print)
except Exception as e:
    print(f"[Setup] Automatic dependency install failed: {e}")
    raise
